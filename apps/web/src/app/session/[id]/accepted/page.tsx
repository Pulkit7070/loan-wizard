  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-2xl font-bold text-navy mb-2">You are all set!</h1>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 mb-6 text-sm text-left">
          ...
          <p className="font-mono font-medium text-navy break-all">{params.id}</p>
        </div>
        ...
        <button
          className="flex items-center justify-center gap-2 w-full border border-navy text-navy py-3 rounded-xl font-medium hover:bg-navy hover:text-white transition-colors"
